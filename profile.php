...
<html lang="en">
  <head>
    ...
    <title>ระบบบันทึกเวลาการเข้าใช้งานคอมพิวเตอร์ ห้อง 9204</title>
  </head>
  <body>
    <div class="container">
      <div class="row">
        <div class="col col-sm-12">
          <h3  class="jumbotron" align="center">ระบบบันทึกเวลาการเข้าใช้งานคอมพิวเตอร์ ห้อง 9204 </h3>
        </div>
      </div>
    </div>
    <div class="container">
      <div class="row">
        <div class="col col-sm-3">
          ...
          <br>
          ระดับชั้น : <?php echo $rowm['m_degree'];?>
          </b>
          <br>
          <a href="logout.php" class="btn btn-danger btn-sm"> logout </a>
        </div>
        <div class="col col-sm-9">
          <h3> ลงเวลาเข้า-ออก <?php echo date('d-m-Y');?></h3>
          <form action="save.php"  method="post" class="form-horizontal">
            <div class="form-group row">
              <div class="col col-sm-2">
                <label for="m_id">เลขที่</label>
                <input type="text" class="form-control"   name="m_id"   placeholder="รหัสนักศึกษา"   value="<?php echo $rowm['m_id'];?>"  readonly>
              </div>
              <div class="col col-sm-3">
                <label for="m_id">เวลาเข้าใช้งาน</label>
              ...
              <div class="col col-sm-3">
                ...
                echo '<br><font color="red">  00.00 น. </font>';
                } ?>
              </div>
